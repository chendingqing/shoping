...
@section('content')
    ...
    <form action="" method="post" class="form-inline" enctype="multipart/form-data">
        ...
        <br/>
        报名开始时间：<input type="date" name="start_time" class="form-control"><br>
        报名结束时间 ：<input type="date" name="end_time" class="form-control"><br>
        开奖时间 ：<input type="date" name="prize_time" class="form-control"><br>
