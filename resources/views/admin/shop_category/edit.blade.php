...
@section("content")
    <form action="" method="post" class="form-inline col-sm-8 control-label" enctype="multipart/form-data">
        {{ csrf_field() }}
        商家分类名称： <input type="text" name="name" placeholder="商家名称" value="{{old("name",$shopCategory->name)}}"><br/>
        商家分类简介： <input type="text" name="shop_intro" placeholder="商家简介" value="{{old("shop_intro",$shopCategory->shop_intro)}}"><br/>
        商家分类图片：
        <img src="{{$shopCategory->shop_img}}"  height="100" width="100">
    ...
    <script>
        ...
        jQuery(function() {
            ...
            uploader = WebUploader.create({
                ...
                // 文件接收服务端。
                server: '{{route('shop_category.upload')}}',
