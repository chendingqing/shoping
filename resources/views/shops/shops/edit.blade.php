...
@section('content')
    ...
    <form action="" method="post" class="form-inline col-sm-8 control-label" enctype="multipart/form-data">
        ...
        <br/>
        <div class="form-group">
            <input type="text" class="form-control"  placeholder="店铺名称" name="shops_name" value="{{old("shops_name",$shop->shops_name)}}">
        </div>
        <br/>
        <div class="form-group">
        ...
        <div class="form-group">
            店铺图片:
            <img src="/uploads/{{$shop->shops_img}}" height="100" width="100">
